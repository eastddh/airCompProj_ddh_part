    ...
    def train(self):
        ...
        for t in range(num_iterations):
            ...
            if first_it or last_it or epoch_end:
                ...
                #print(train_acc,'train trainacc')
...
small_data = {
  'X_train': trainSet.pos,
  'y_train': trainSet.RSSI,
  'X_val': testSet.pos,
  'y_val': testSet.RSSI,
}
...
train_norm,_ = mse_loss(np.zeros((len(trainSet.RSSI),1)), trainSet.RSSI)
test_norm,_ = mse_loss(np.zeros((len(testSet.RSSI),1)), (testSet.RSSI))

pos = testSet.pos
rss = testSet.RSSI 
pre_rss = bn_solver.val_pred
check = random.sample(range(50), 10)
print('Randomly check some of the test points')
print((pre_rss-rss)[check],'difference of predict and RSSI')
print('real RSSI',rss[check])
print('predicted RSSI', pre_rss[check])
